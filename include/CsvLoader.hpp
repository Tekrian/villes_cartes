...
class CsvLoader {
    private :
        ...
        std::vector<std::string> splitLigne(const std::string&) const; // fonction privée qui lit les lignes csv et le met les données en vecteur en éliminant les virgules
